                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h2 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">There is a special Kente for everyone.</h2>
                                    <h5 data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">Clothing you with Royalty</h5>
                                </div>
                            </div>
