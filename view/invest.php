    ...
    <main>
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Invest in Kente Master</h2>
                    </div>
                    <div class="col-lg-8">
                        <form  action="https://formspree.io/mnqgrokw" method="post">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="_replyto" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="Phone Number" id="number" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Phone number'" placeholder="Enter Phone number">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
